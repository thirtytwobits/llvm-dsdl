                          ...
                          const EmitWritePolicy&           writePolicy)
{
    ...
    {
        if (auto err = writeGeneratedFile(initPath, "# Generated by llvmdsdl (Python backend).\n", writePolicy))
        {
            return err;
        }
    }
                       ...
                       DiagnosticEngine&        diagnostics)
{
    ...
    if (auto err = writeGeneratedFile(packageRoot / "_dsdl_runtime.py", *runtime, options.writePolicy))
    {
        return err;
    }
    ...
    if (auto err = writeGeneratedFile(packageRoot / "_runtime_loader.py", *runtimeLoader, options.writePolicy))
    {
        return err;
    }
