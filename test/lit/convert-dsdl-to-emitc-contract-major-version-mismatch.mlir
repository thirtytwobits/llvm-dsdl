...
module attributes {llvmdsdl.lowered_contract_producer = "lower-dsdl-exec", llvmdsdl.lowered_contract_version = 3 : i64} {
...
// CHECK: error: unsupported lowered SerDes contract major version: expected 2, got 3 (encoded version 3); run matching lower-dsdl-exec before convert-dsdl-to-emitc
