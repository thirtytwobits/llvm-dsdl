...
module attributes {llvmdsdl.lowered_contract_producer = "wrong-pass", llvmdsdl.lowered_contract_version = 2 : i64} {
...
// CHECK: error: lowered SerDes contract producer mismatch: expected 'lower-dsdl-exec'; run lower-dsdl-exec before convert-dsdl-to-emitc
