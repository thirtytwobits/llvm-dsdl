...
module {
  dsdl.schema @test_BadAlignBits_1_0 attributes {full_name = "test.BadAlignBits", major = 1 : i32, minor = 0 : i32, sealed} {
    dsdl.serialization_plan attributes {c_deserialize_symbol = "test__BadAlignBits__deserialize_", c_serialize_symbol = "test__BadAlignBits__serialize_", c_type_name = "test__BadAlignBits", max_bits = 8 : i64, min_bits = 0 : i64} {
      dsdl.align {bits = 0 : i32}
...
// CHECK: error: 'dsdl.align' op requires positive 'bits' value
