...
void dumpBytes(const char *const label, const std::uint8_t *const data,
  ...
  for (std::size_t iter = 0; iter < iterations; ++iter) {
    ...
    if ((cDesResult != cppDesResult) || (cConsumed != cppConsumed)) {
      std::fprintf(stderr,
                   ...
                   "C++(rc=%d,consumed=%zu)\n",
                   name, iter, inputSize, static_cast<int>(cDesResult), cConsumed,
    ...
    const bool byteMismatch =
        compareBytes && (cSize == cppSize) &&
        (std::memcmp(cOutput, cppOutput, cSize) != 0);
...
std::int8_t cHeartbeatDeserialize(uavcan__node__Heartbeat *outObj,
                                  const std::uint8_t *buffer,
                                  std::size_t *inoutSize);
std::int8_t cHeartbeatSerialize(const uavcan__node__Heartbeat *obj,
                                std::uint8_t *buffer, std::size_t *inoutSize);
std::int8_t cppHeartbeatDeserialize(uavcan::node::Heartbeat *outObj,
                                    const std::uint8_t *buffer,
                                    std::size_t *inoutSize);
std::int8_t cppHeartbeatSerialize(const uavcan::node::Heartbeat *obj,
                                  std::uint8_t *buffer, std::size_t *inoutSize);
std::int8_t cExecuteRequestSerialize(
    const uavcan__node__ExecuteCommand__Request *obj, std::uint8_t *buffer,
    std::size_t *inoutSize);
std::int8_t cExecuteRequestDeserialize(
    uavcan__node__ExecuteCommand__Request *outObj, const std::uint8_t *buffer,
    std::size_t *inoutSize);
std::int8_t cppExecuteRequestSerialize(
    const uavcan::node::ExecuteCommand_1_3__Request *obj, std::uint8_t *buffer,
    std::size_t *inoutSize);
std::int8_t cppExecuteRequestDeserialize(
    uavcan::node::ExecuteCommand_1_3__Request *outObj,
    const std::uint8_t *buffer, std::size_t *inoutSize);
std::int8_t cExecuteResponseDeserialize(
    uavcan__node__ExecuteCommand__Response *outObj, const std::uint8_t *buffer,
    std::size_t *inoutSize);
std::int8_t cExecuteResponseSerialize(
    const uavcan__node__ExecuteCommand__Response *obj, std::uint8_t *buffer,
    std::size_t *inoutSize);
std::int8_t cppExecuteResponseDeserialize(
    uavcan::node::ExecuteCommand_1_3__Response *outObj,
    const std::uint8_t *buffer, std::size_t *inoutSize);
std::int8_t cppExecuteResponseSerialize(
    const uavcan::node::ExecuteCommand_1_3__Response *obj,
    std::uint8_t *buffer, std::size_t *inoutSize);
std::int8_t cFrameDeserialize(uavcan__metatransport__can__Frame *outObj,
                              const std::uint8_t *buffer,
                              std::size_t *inoutSize);
std::int8_t cFrameSerialize(const uavcan__metatransport__can__Frame *obj,
                            std::uint8_t *buffer, std::size_t *inoutSize);
std::int8_t cppFrameDeserialize(uavcan::metatransport::can::Frame_0_2 *outObj,
                                const std::uint8_t *buffer,
                                std::size_t *inoutSize);
std::int8_t cppFrameSerialize(
    const uavcan::metatransport::can::Frame_0_2 *obj, std::uint8_t *buffer,
    std::size_t *inoutSize);
std::int8_t cHealthDeserialize(uavcan__node__Health *outObj,
                               const std::uint8_t *buffer,
                               std::size_t *inoutSize);
std::int8_t cHealthSerialize(const uavcan__node__Health *obj,
                             std::uint8_t *buffer, std::size_t *inoutSize);
std::int8_t cppHealthDeserialize(uavcan::node::Health *outObj,
                                 const std::uint8_t *buffer,
                                 std::size_t *inoutSize);
std::int8_t cppHealthSerialize(const uavcan::node::Health *obj,
                               std::uint8_t *buffer, std::size_t *inoutSize);
std::int8_t cSynchronizedTimestampDeserialize(
    uavcan__time__SynchronizedTimestamp *outObj, const std::uint8_t *buffer,
    std::size_t *inoutSize);
std::int8_t cSynchronizedTimestampSerialize(
    const uavcan__time__SynchronizedTimestamp *obj, std::uint8_t *buffer,
    std::size_t *inoutSize);
std::int8_t cppSynchronizedTimestampDeserialize(
    uavcan::time::SynchronizedTimestamp *outObj, const std::uint8_t *buffer,
    std::size_t *inoutSize);
...
int runDirectedErrorCases() {
  {
    ...
    if ((cRc != expected) || (cppRc != expected) || (cConsumed != cppConsumed) ||
      ...
      std::fprintf(stderr,
                   ...
                   static_cast<int>(cRc), cConsumed, static_cast<int>(cppRc),
                   cppConsumed);
      return 1;
    }
  }
...

  {
    ...
    std::size_t cConsumed = sizeof(input);
    std::size_t cppConsumed = sizeof(input);
    const std::int8_t cDesRc =
        cExecuteRequestDeserialize(&cObj, input, &cConsumed);
    const std::int8_t cppDesRc =
        cppExecuteRequestDeserialize(&cppObj, input, &cppConsumed);
    if ((cDesRc != 0) || (cppDesRc != 0) || (cConsumed != cppConsumed)) {
      std::fprintf(stderr,
                   "Directed mismatch (ExecuteCommand.Request truncated-payload deserialize): "
                   "C(rc=%d,consumed=%zu) C++(rc=%d,consumed=%zu)\n",
                   static_cast<int>(cDesRc), cConsumed, static_cast<int>(cppDesRc),
                   cppConsumed);
      return 1;
    }
    ...
    const std::int8_t cSerRc =
        cExecuteRequestSerialize(&cObj, cOut, &cSize);
    const std::int8_t cppSerRc =
        cppExecuteRequestSerialize(&cppObj, cppOut, &cppSize);
    const bool byteMismatch =
        (cSize == cppSize) && (std::memcmp(cOut, cppOut, cSize) != 0);
    if ((cSerRc != cppSerRc) || (cSize != cppSize) || byteMismatch) {
      std::fprintf(stderr,
                   ...
                   static_cast<int>(cSerRc), cSize, static_cast<int>(cppSerRc),
                   cppSize);
...

  {
    ...
    std::size_t cppConsumed = sizeof(input);
    const std::int8_t cDesRc =
        cExecuteResponseDeserialize(&cObj, input, &cConsumed);
    const std::int8_t cppDesRc =
        cppExecuteResponseDeserialize(&cppObj, input, &cppConsumed);
    if ((cDesRc != 0) || (cppDesRc != 0) || (cConsumed != cppConsumed)) {
      std::fprintf(stderr,
    ...
    const std::int8_t cSerRc =
        cExecuteResponseSerialize(&cObj, cOut, &cSize);
    const std::int8_t cppSerRc =
        cppExecuteResponseSerialize(&cppObj, cppOut, &cppSize);
    const bool byteMismatch =
        (cSize == cppSize) && (std::memcmp(cOut, cppOut, cSize) != 0);
    if ((cSerRc != cppSerRc) || (cSize != cppSize) || byteMismatch) {
      std::fprintf(stderr,
...

  {
    ...
    std::size_t cConsumed = sizeof(input);
    std::size_t cppConsumed = sizeof(input);
    const std::int8_t cRc =
        uavcan__node__port__List__deserialize_(&cObj, input, &cConsumed);
...

  {
    ...
    const std::uint8_t input[5] = {
        0x01U, 0x00U, 0x00U, 0x00U, 0xFFU}; // publishers delimiter=1, nested _tag_=255
    uavcan__node__port__List cObj{};
    uavcan::node::port::List_1_0 cppObj{};
    std::size_t cConsumed = sizeof(input);
    std::size_t cppConsumed = sizeof(input);
...

  {
    ...
    const std::uint8_t input[9] = {
        0x00U, 0x00U, 0x00U, 0x00U, // publishers delimiter=0
        0x01U, 0x00U, 0x00U, 0x00U, // subscribers delimiter=1
...

  {
    ...
    const std::uint8_t input[12] = {
        0x00U, 0x00U, 0x00U, 0x00U, // publishers delimiter=0
        0x00U, 0x00U, 0x00U, 0x00U, // subscribers delimiter=0
        0xFFU, 0xFFU, 0xFFU, 0x7FU  // clients delimiter invalid
    };
    uavcan__node__port__List cObj{};
    uavcan::node::port::List_1_0 cppObj{};
    std::size_t cConsumed = sizeof(input);
...

  {
    ...
    cppObj.publishers.sparse_list.resize(
        uavcan::node::port::SubjectIDList_1_0::SPARSE_LIST_ARRAY_CAPACITY + 1U);
    std::uint8_t cBuffer[9000]{};
    std::uint8_t cppBuffer[9000]{};
    std::size_t cSize = static_cast<std::size_t>(
        uavcan__node__port__List_SERIALIZATION_BUFFER_SIZE_BYTES_);
    std::size_t cppSize =
        uavcan::node::port::List_1_0::SERIALIZATION_BUFFER_SIZE_BYTES;
    const std::int8_t cRc =
        uavcan__node__port__List__serialize_(&cObj, cBuffer, &cSize);
    ...
    if ((cRc != expected) || (cppRc != expected)) {
      std::fprintf(stderr,
                   ...
                   "C(rc=%d,size=%zu) C++(rc=%d,size=%zu)\n",
                   static_cast<int>(cRc), cSize, static_cast<int>(cppRc),
                   cppSize);
      return 1;
    }
  }
...

  {
    ...
    std::size_t cSize = static_cast<std::size_t>(
        uavcan__node__ExecuteCommand__Request_SERIALIZATION_BUFFER_SIZE_BYTES_ - 1U);
    std::size_t cppSize =
        uavcan::node::ExecuteCommand_1_3__Request::SERIALIZATION_BUFFER_SIZE_BYTES - 1U;
    const std::int8_t cRc =
        cExecuteRequestSerialize(&cObj, cBuffer, &cSize);
    const std::int8_t cppRc =
        cppExecuteRequestSerialize(&cppObj, cppBuffer, &cppSize);
...

  {
    ...
    cppObj.command = 0U;
    cppObj.parameter.resize(
        uavcan::node::ExecuteCommand_1_3__Request::PARAMETER_ARRAY_CAPACITY + 1U,
        0U);
    std::uint8_t cBuffer[300]{};
    std::uint8_t cppBuffer[300]{};
    std::size_t cSize = static_cast<std::size_t>(
...

  {
    ...
    cppObj.status = 0U;
    cppObj.output.resize(
        uavcan::node::ExecuteCommand_1_3__Response::OUTPUT_ARRAY_CAPACITY + 1U,
        0U);
    std::uint8_t cBuffer[128]{};
    std::uint8_t cppBuffer[128]{};
    std::size_t cSize = static_cast<std::size_t>(
    ...
    const std::int8_t cppRc =
        cppExecuteResponseSerialize(&cppObj, cppBuffer, &cppSize);
    const std::int8_t expected = static_cast<std::int8_t>(-10);
    if ((cRc != expected) || (cppRc != expected)) {
      std::fprintf(stderr,
...

  {
    ...
    std::size_t cSize = static_cast<std::size_t>(
        uavcan__node__Heartbeat_SERIALIZATION_BUFFER_SIZE_BYTES_ - 1U);
    std::size_t cppSize =
        uavcan::node::Heartbeat::SERIALIZATION_BUFFER_SIZE_BYTES - 1U;
...

  {
    ...
    std::uint8_t cppBuffer[8]{};
    std::size_t cSize =
        static_cast<std::size_t>(uavcan__node__Health_SERIALIZATION_BUFFER_SIZE_BYTES_);
...

  {
    ...
    const std::uint8_t expected[7] = {
        0x10U, 0x32U, 0x54U, 0x76U, 0x98U, 0xBAU, 0xDCU};
    ...
    const std::int8_t cRc =
        cSynchronizedTimestampSerialize(&cObj, cBuffer, &cSize);
    const std::int8_t cppRc =
        cppSynchronizedTimestampSerialize(&cppObj, cppBuffer, &cppSize);
    const bool cExpected = (cSize == 7U) && (std::memcmp(cBuffer, expected, 7U) == 0);
    const bool cppExpected =
        (cppSize == 7U) && (std::memcmp(cppBuffer, expected, 7U) == 0);
    if ((cRc != 0) || (cppRc != 0) || (cSize != cppSize) ||
        (std::memcmp(cBuffer, cppBuffer, cSize) != 0) || !cExpected ||
        !cppExpected) {
      std::fprintf(stderr,
                   "Directed mismatch (SynchronizedTimestamp truncating serialize): "
                   "C(rc=%d,size=%zu) C++(rc=%d,size=%zu)\n",
                   static_cast<int>(cRc), cSize, static_cast<int>(cppRc), cppSize);
...
std::int8_t cExecuteRequestDeserialize(
    uavcan__node__ExecuteCommand__Request *const outObj,
    const std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return uavcan__node__ExecuteCommand__Request__deserialize_(outObj, buffer,
                                                             inoutSize);
}
std::int8_t cExecuteRequestSerialize(
    const uavcan__node__ExecuteCommand__Request *const obj,
    std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return uavcan__node__ExecuteCommand__Request__serialize_(obj, buffer,
                                                           inoutSize);
}
std::int8_t cppExecuteRequestDeserialize(
    uavcan::node::ExecuteCommand_1_3__Request *const outObj,
    const std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return outObj->deserialize(buffer, inoutSize);
}
std::int8_t cppExecuteRequestSerialize(
    const uavcan::node::ExecuteCommand_1_3__Request *const obj,
    std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return obj->serialize(buffer, inoutSize);
}

std::int8_t cExecuteResponseDeserialize(
    uavcan__node__ExecuteCommand__Response *const outObj,
    const std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return uavcan__node__ExecuteCommand__Response__deserialize_(outObj, buffer,
                                                              inoutSize);
}
std::int8_t cExecuteResponseSerialize(
    const uavcan__node__ExecuteCommand__Response *const obj,
    std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return uavcan__node__ExecuteCommand__Response__serialize_(obj, buffer,
                                                            inoutSize);
}
std::int8_t cppExecuteResponseDeserialize(
    uavcan::node::ExecuteCommand_1_3__Response *const outObj,
    const std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return outObj->deserialize(buffer, inoutSize);
}
std::int8_t cppExecuteResponseSerialize(
    const uavcan::node::ExecuteCommand_1_3__Response *const obj,
    std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return obj->serialize(buffer, inoutSize);
}
...
std::int8_t cFrameDeserialize(uavcan__metatransport__can__Frame *const outObj,
                              const std::uint8_t *const buffer,
                              std::size_t *const inoutSize) {
  return uavcan__metatransport__can__Frame__deserialize_(outObj, buffer,
                                                         inoutSize);
}
std::int8_t cFrameSerialize(
    const uavcan__metatransport__can__Frame *const obj,
    std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return uavcan__metatransport__can__Frame__serialize_(obj, buffer, inoutSize);
}
std::int8_t cppFrameDeserialize(
    uavcan::metatransport::can::Frame_0_2 *const outObj,
    const std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return outObj->deserialize(buffer, inoutSize);
}
std::int8_t cppFrameSerialize(
    const uavcan::metatransport::can::Frame_0_2 *const obj,
    std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return obj->serialize(buffer, inoutSize);
}
...
std::int8_t cSynchronizedTimestampDeserialize(
    uavcan__time__SynchronizedTimestamp *const outObj,
    const std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return uavcan__time__SynchronizedTimestamp__deserialize_(outObj, buffer,
                                                           inoutSize);
}
std::int8_t cSynchronizedTimestampSerialize(
    const uavcan__time__SynchronizedTimestamp *const obj,
    std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return uavcan__time__SynchronizedTimestamp__serialize_(obj, buffer, inoutSize);
}
std::int8_t cppSynchronizedTimestampDeserialize(
    uavcan::time::SynchronizedTimestamp *const outObj,
    const std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return outObj->deserialize(buffer, inoutSize);
}
std::int8_t cppSynchronizedTimestampSerialize(
    const uavcan::time::SynchronizedTimestamp *const obj,
    std::uint8_t *const buffer, std::size_t *const inoutSize) {
  return obj->serialize(buffer, inoutSize);
}
...
int main(int argc, char **argv) {
  ...
  if (runCase<uavcan__node__Heartbeat, uavcan::node::Heartbeat>(
          "uavcan.node.Heartbeat.1.0", iterations,
          static_cast<std::size_t>(
              uavcan__node__Heartbeat_SERIALIZATION_BUFFER_SIZE_BYTES_),
          uavcan::node::Heartbeat::SERIALIZATION_BUFFER_SIZE_BYTES,
          cHeartbeatDeserialize, cHeartbeatSerialize, cppHeartbeatDeserialize,
          cppHeartbeatSerialize) != 0) {
    return 1;
  }

  if (runCase<uavcan__node__ExecuteCommand__Request,
              uavcan::node::ExecuteCommand_1_3__Request>(
          "uavcan.node.ExecuteCommand.Request.1.3", iterations,
          static_cast<std::size_t>(
              uavcan__node__ExecuteCommand__Request_SERIALIZATION_BUFFER_SIZE_BYTES_),
          uavcan::node::ExecuteCommand_1_3__Request::SERIALIZATION_BUFFER_SIZE_BYTES,
          cExecuteRequestDeserialize, cExecuteRequestSerialize,
          cppExecuteRequestDeserialize, cppExecuteRequestSerialize) != 0) {
    return 1;
  }

  if (runCase<uavcan__node__ExecuteCommand__Response,
              uavcan::node::ExecuteCommand_1_3__Response>(
          "uavcan.node.ExecuteCommand.Response.1.3", iterations,
          static_cast<std::size_t>(
              uavcan__node__ExecuteCommand__Response_SERIALIZATION_BUFFER_SIZE_BYTES_),
          uavcan::node::ExecuteCommand_1_3__Response::SERIALIZATION_BUFFER_SIZE_BYTES,
          cExecuteResponseDeserialize, cExecuteResponseSerialize,
          cppExecuteResponseDeserialize, cppExecuteResponseSerialize) != 0) {
    return 1;
  }

  if (runCase<uavcan__metatransport__can__Frame,
              uavcan::metatransport::can::Frame_0_2>(
          "uavcan.metatransport.can.Frame.0.2", iterations,
          static_cast<std::size_t>(
              uavcan__metatransport__can__Frame_SERIALIZATION_BUFFER_SIZE_BYTES_),
          uavcan::metatransport::can::Frame_0_2::SERIALIZATION_BUFFER_SIZE_BYTES,
          cFrameDeserialize, cFrameSerialize, cppFrameDeserialize,
          cppFrameSerialize) != 0) {
    return 1;
  }

  if (runCase<uavcan__node__Health, uavcan::node::Health>(
          "uavcan.node.Health.1.0", iterations,
          static_cast<std::size_t>(
              uavcan__node__Health_SERIALIZATION_BUFFER_SIZE_BYTES_),
          uavcan::node::Health::SERIALIZATION_BUFFER_SIZE_BYTES,
          cHealthDeserialize, cHealthSerialize, cppHealthDeserialize,
  ...
  if (runCase<uavcan__time__SynchronizedTimestamp,
          ...
          "uavcan.time.SynchronizedTimestamp.1.0", iterations,
          static_cast<std::size_t>(
              uavcan__time__SynchronizedTimestamp_SERIALIZATION_BUFFER_SIZE_BYTES_),
          uavcan::time::SynchronizedTimestamp::SERIALIZATION_BUFFER_SIZE_BYTES,
