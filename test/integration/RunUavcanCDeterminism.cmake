...
file(
  ...
  "#!/bin/sh\n"
  "set -eu\n"
  "\"${DSDLC}\" --target-language c \"${UAVCAN_ROOT}\" --outdir \"${out_a}\" >\"${OUT_DIR}/run-a.stdout\" 2>\"${OUT_DIR}/run-a.stderr\" &\n"
  "pid_a=$!\n"
  "\"${DSDLC}\" --target-language c \"${UAVCAN_ROOT}\" --outdir \"${out_b}\" >\"${OUT_DIR}/run-b.stdout\" 2>\"${OUT_DIR}/run-b.stderr\" &\n"
  "pid_b=$!\n"
  "wait \"$pid_a\"\n"
  "wait \"$pid_b\"\n")
