...
static int run_int3sat(const uint8_t *const input, const size_t input_size,
...
static int run_int3trunc(const uint8_t *const input, const size_t input_size,
                         uint8_t *const output, const size_t output_capacity,
                         CCaseResult *const result) {
...
int c_int3sat_roundtrip(const uint8_t *const input, const size_t input_size,
                        uint8_t *const output, const size_t output_capacity,
                        CCaseResult *const result) {
...
int c_int3trunc_roundtrip(const uint8_t *const input, const size_t input_size,
                          uint8_t *const output, const size_t output_capacity,
                          CCaseResult *const result) {
  if ((input == NULL) || (output == NULL) || (result == NULL)) {
    return -1;
...
int c_int3sat_directed_serialize(const int8_t value, uint8_t *const output,
...
int c_int3trunc_directed_serialize(const int8_t value, uint8_t *const output,
                                   const size_t output_capacity,
                                   CCaseResult *const result) {
  if ((output == NULL) || (result == NULL)) {
    return -1;
...
int c_int3sat_deserialize_value(const uint8_t sample, int8_t *const out_value,
                                CCaseResult *const result) {
...
int c_int3trunc_deserialize_value(const uint8_t sample, int8_t *const out_value,
                                  CCaseResult *const result) {
  if ((out_value == NULL) || (result == NULL)) {
    return -1;
  }
