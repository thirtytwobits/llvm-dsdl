...
void printHelp(const std::string& selectedCommand = "")
{
    llvm::errs()
        ...
        << "  dsdlc rust --root-namespace-dir public_regulated_data_types/uavcan --rust-runtime-specialization fast "
           "--rust-profile std --rust-crate-name uavcan_dsdl_fast --out-dir build/uavcan-rust-fast\n"
        << "  dsdlc rust --root-namespace-dir public_regulated_data_types/uavcan --rust-profile no-std-alloc "
